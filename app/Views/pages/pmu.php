<?php
$heroEyebrow = 'PMU';
$heroText = "Toutes les courses hippiques du jour, vos paris préférés et le suivi des résultats, directement en boutique.";
$heroActions = [
...
<section class="max-w-[1536px] mx-auto px-6 lg:px-10 py-12 space-y-6">
  ...
  <div class="card card-md flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      <h2 class="font-bold text-ink mb-1">Horaires de prise de paris</h2>
