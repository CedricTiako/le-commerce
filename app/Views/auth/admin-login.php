...
<div class="w-full max-w-md bg-ink text-white rounded-2xl shadow-sm p-8">
  <div class="flex items-center gap-2 mb-1">
    ...
    <h1 class="font-extrabold text-2xl">Espace Administrateur</h1>
  </div>
  <p class="text-gray-400 text-sm mb-6">Réservé au personnel du Commerce.</p>
  ...
  <form method="POST" action="<?= BASE_PATH ?>/admin/connexion" class="space-y-4">
    ...
    <div>
      <label class="block text-sm font-semibold mb-1.5">Adresse e-mail</label>
